/**
 * Freshness Filter
 * Sorts jobs by recency and adds freshness metadata
 */

import { differenceInDays } from "date-fns";

/**
 * Sorts jobs by freshness (newest first) and prioritizes recent postings
 * @param {Array} jobs - Array of job objects
 * @param {Object} preferences - User preferences with freshness settings
 * @returns {Array} Sorted jobs
 */
export function sortByFreshness(jobs, preferences) {
